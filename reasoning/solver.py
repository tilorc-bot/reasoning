...
"""
# Derived from SymPy's ``logic.algorithms.dpll2`` under its BSD license.
# See LICENSE.sympy in this package.
...
class SATSolver:
    ...
    def __init__(self, clauses: Iterable[Iterable[int]],
        ...
        # Integer literal IDs are dense in ClauseDB. Accept sparse callers as
        # well because this solver indexes assignment state by literal ID.
        if variables:
    ...
    def propagate(self) -> IpasirStatus:
        ...
        >>> from reasoning.solver import SATSolver, IpasirStatus
